...
public class AutoPositionCoralCommand extends Command{
  ...
  public AutoPositionCoralCommand(Elevator elevator, CoralIntake coralIntake, AlgaeIntake algaeIntake, MergedCoralScorePositions mergedCoralScorePositions) {
  ...
  public void execute() {
    ...
    switch (mergedCoralScorePositions) {
      ...
      case INTAKE:
        ...
        coralIntake.moveCoralIntake(CoralIntakeMode.INTAKE_PICKUP, 0);
        break;

      case L1:
        elevator.moveElevator(ElevatorHeights.L1);
        coralIntake.moveCoralIntake(CoralIntakeMode.L1_EJECT, 0);
        break;

      case L2:
        elevator.moveElevator(ElevatorHeights.L2);
        coralIntake.moveCoralIntake(CoralIntakeMode.L2_AND_L3EJECT, 0);
        break;
      ...
      case L4:
        ...
        coralIntake.moveCoralIntake(CoralIntakeMode.L4_EJECT, 0);
        break;
    }
  }
